...
void Sd2Card::chipSelectHigh(void) {
  fastDigitalWrite(SD_CHIPSELECT, HIGH);
#ifdef USE_SPI_LIB
...
#endif
  fastDigitalWrite(SD_CHIPSELECT, LOW);
}
//------------------------------------------------------------------------------
...
uint8_t Sd2Card::init(uint8_t sckRateID) {
  ...
  // set pin modes
  setPinMode(SD_CHIPSELECT, OUTPUT);
  fastDigitalWrite(SD_CHIPSELECT, HIGH);
#ifndef USE_SPI_LIB
  ...
  setPinMode(SS_PIN, OUTPUT);
  fastDigitalWrite(SS_PIN, HIGH); // disable any SPI device using hardware SS pin
