/*
  ...
  Copyright (c) 2009-2011 Simen Svale Skogsrud
	modified for use on a lathe, 2021 by how_eee, using Huub Buis MetalWorkerrTools code
...
// #define INVERT_LIMIT_PIN_MASK ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)) // Default disabled. Uncomment to enable.
  ...
  #define INVERT_MAX_LIMIT_PIN_MASK ((1<<X_AXIS) | /*(1<<Y_AXIS) |*/ (1<<Z_AXIS)) // Normal Conected Switches on X and Z with pullup to +5v. Y is not connected 
#endif
...
#define ENABLE_SOFTWARE_DEBOUNCE // Default disabled. Uncomment to enable.  Default enabled for the lathe
...
#define USE_UI_SUPPORT
  ...
  #define UI_KEYPAD_ORIENTATION 0
	...
	#define UI_JOGGING_INITIAL_METRIC_RANGE   4
	#define UI_JOGGING_INITIAL_FEED   50.0
